    ...
    <div className="flex items-start justify-between">
      ...
      <div className="lg:flex items-center gap-3 hidden">
        <Link
          ...
          className="group cursor-[url('/resona.png')_16_16,pointer] elevated flex items-center gap-2 rounded-2xl border border-border/60 bg-card/70 px-4 py-2 shadow-sm transition-all duration-200 hover:scale-105 hover:shadow-lg hover:bg-[linear-gradient(90deg,oklch(0.72_0.13_25/.15),oklch(0.75_0.15_300/.15))]"
        >
          <FaGithub
