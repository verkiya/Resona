// Sentry demo page: checks client connectivity and lets users trigger a sample error for validation.
"use client";
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://himanshu-verkiya-ej.sentry.io/issues/?project=4511268283809792"
          >
            Issues Page
          </a>
